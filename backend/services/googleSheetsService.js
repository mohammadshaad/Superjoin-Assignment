...
const auth = new google.auth.GoogleAuth({
  keyFile: path.join(__dirname, '../../service.json'), // Path to your credentials JSON file
  scopes: ['https://www.googleapis.com/auth/spreadsheets']
});

let spreadsheetId = '1Ako5bdxDxuUm9lnRnIVkUHRAtBwdoz6h0SfUD9pSwz0'; // Replace with your Google Sheet ID
